...
public:
	...
	AActor* PerformMousePicking(FCamera& InCamera, int32 MouseX, int32 MouseY, float ScreenW, float ScreenH, float perspectiveRatio, const FRenderCollector& RenderCollector);
	void Update(float deltaTime, FCamera& InCamera, float perspectiveRatio, FSceneManager* sceneManager);
